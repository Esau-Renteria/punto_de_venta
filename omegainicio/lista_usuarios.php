	...
	<section id="container">
		...
		<table>
			<tr>
				...
				$query = mysqli_query($conection,"SELECT u.idusuario, u.nombre, u.correo, u.usuario, r.rol FROM usuario u INNER JOIN rol r ON u.rol = r.idrol WHERE estado = 1 ORDER BY u.idusuario ASC LIMIT $desde,$por_pagina"); 
				...
				<td>
					...
					?>
					|
					<a class="link_delete" href="confirmacion_eliminar.php?id=<?php echo $data["idusuario"]; ?>"><i class="fas fa-trash-alt"></i> Eliminar</a>
					<?php } ?>
				</td>
				</tr>
			<?php
